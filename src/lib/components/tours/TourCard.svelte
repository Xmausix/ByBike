...
>
	...
	<div class="p-2 md:pb-6 text-center md:p-4">
		<h3 class="text-blue font-roboto text-left text-sm font-bold md:text-xl">{tour.name}</h3>
		<p class="text-blue font-open-sans mt-1 text-left text-xs sm:text-sm">{tour.tagLine}</p>
